...
type
  ...
  public
    ...
    function Send(const AValue; ASize: Integer): Integer;
...
function TBTManager.Send(const AValue; ASize: Integer): Integer;
begin
  fpsend(FSocket, @AValue, ASize, 0);
end;

function TBTManager.Receive(out AValue; ASize: Integer): Integer;
begin
  fprecv(FSocket, @AValue, ASize, 0);
end;
